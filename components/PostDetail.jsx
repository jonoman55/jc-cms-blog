        ...
        <>
            <div className="pb-12 mb-8 bg-white rounded-lg shadow-lg lg:p-8">
                <div className="relative mb-6 overflow-hidden shadow-md">
                    <img className="object-cover object-top w-full h-full rounded-t-lg shadow-lg lg:rounded-lg" src={post.featuredImage.url} alt="" />
                </div>
                <div className="px-4 lg:px-0">
                    <div className="flex items-center w-full mb-8">
                        ...
                        <div className="font-medium text-gray-700">
                            <svg className="inline w-6 h-6 mr-2 text-pink-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
